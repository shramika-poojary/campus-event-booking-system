...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<String> handle(ListIsEmptyException ls){
		return new ResponseEntity<String>(ls.getMessage(),HttpStatus.NO_CONTENT);
	}
	
	@ExceptionHandler(EventAlreadyBookedException.class)
	public ResponseEntity<String> handle(EventAlreadyBookedException ev){
		return new ResponseEntity<String>(ev.getMessage(),HttpStatus.CONFLICT);
		
	}

	@ExceptionHandler(NoSeatsAvailableException.class)
	public ResponseEntity<String> handle(NoSeatsAvailableException ns){
		return new ResponseEntity<String>(ns.getMessage(),HttpStatus.NO_CONTENT);
	}
